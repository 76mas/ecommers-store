            ...
            {loading ? (
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4">
                {[...Array(8)].map((_, i) => (
                  <div
                    key={i}
                    className="space-y-5 p-4 rounded-2xl shadow-md bg-white animate-pulse"
                  >
                    <div className="h-36 w-full bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-xl bg-[length:200%_100%] animate-shimmer"></div>
